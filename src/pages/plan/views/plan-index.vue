<template>
        <div class="main1" v-infinite-scroll="loadMore" infinite-scroll-disabled="busy" infinite-scroll-distance="20">
            ...
            <div class="data-list">  
                ...
                <div class="data-item" v-else v-for="(item,index) in dataList" :key="index" @click="goDetail('/planDetail?id='+item.id)">
                    ...
                    <div class="data-title">                        
                        <h2 class="data-t-text">{{item.kindergartenName}}</h2>
                        <p class="data-des">园长：{{item.principalName}}</p>
                    </div>                   
                </div>
            </div>
	...
	export default {
		...
		methods: {
            ...
            async getDataList(keyword){
                ...
                // const getListInfo = await request('/api/goods/goodsKgplant/list',
                const getListInfo = await request('/api/base/kindergarten/list',
        ...
        .data-list{
            ...
            .data-item{
                ...
                .data-pic{
                    ...
                    border-top-left-radius: 30rem/@rootFontSize;
                    border-top-right-radius: 30rem/@rootFontSize;
                    margin-bottom: 10rem/@rootFontSize;
                }
                .data-title{
                    width:100%;
